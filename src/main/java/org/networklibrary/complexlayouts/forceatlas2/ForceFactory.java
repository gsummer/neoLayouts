...
public class ForceFactory {
    ...
    private class linRepulsion extends RepulsionForce {
        ...
        public void apply(Node n1, Node n2) {
            ForceAtlas2LayoutData n1Layout = LayoutDataRegistry.getInstance().getLayoutData(n1);
            ForceAtlas2LayoutData n2Layout = LayoutDataRegistry.getInstance().getLayoutData(n2);
        ...
        public void apply(Node n, Region r) {
            ForceAtlas2LayoutData nLayout = LayoutDataRegistry.getInstance().getLayoutData(n);
    ...
    private class linRepulsion_antiCollision extends RepulsionForce {
        ...
        public void apply(Node n1, Node n2) {
            ...
            double xDist = n1Layout.x() - n2Layout.x();
            double yDist = n1Layout.y() - n2Layout.y();
            double distance = Math.sqrt(xDist * xDist + yDist * yDist) - n1Layout.size() - n2Layout.size();
